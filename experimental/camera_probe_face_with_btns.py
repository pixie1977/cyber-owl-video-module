...
print("🚀 Распознавание + интерфейс. Используйте кнопки: [S], [R], [Q]")
...
def draw_ui(frame, status_msg=""):
    ...
    draw_button("[R] Reload", 120, (150, 150, 0)) # Жёлто-коричневая
...
while True:
    ...
    if key == ord('q'):
        ...
        if len(current_detections) == 1:
            ...
            status_message = "⚠️ Нужно ровно одно лицо для сохранения"
    ...
    cv2.imshow('Cyber Owl - Face Recognition', frame)
